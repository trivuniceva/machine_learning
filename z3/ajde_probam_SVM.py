...
train_data['preprocessed_strofa'] = train_data['strofa'].apply(preprocess_text)
test_data['preprocessed_strofa'] = test_data['strofa'].apply(preprocess_text)

vectorizer = CountVectorizer()
X_train = vectorizer.fit_transform(train_data['preprocessed_strofa'])
y_train = train_data['zanr']

X_test = vectorizer.transform(test_data['preprocessed_strofa'])
